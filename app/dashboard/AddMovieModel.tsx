...
export default function AddMovieModal() {
  ...
  const validateForm = () => {
    ...
    if (!title || !poster || !rating || !genre.length || !quality || !language || !category) {
  ...
  return (
    <Dialog>
      <DialogTrigger>
        <Button><div className="cursor-pointer">Add Movie</div></Button>
      </DialogTrigger>
      ...
      <DialogContent>
        <div className="max-h-[90vh] overflow-y-auto">
          <div className="space-y-4 pb-4">
            ...
            <div
              className="space-y-4 overflow-y-auto pl-1 pr-2"
